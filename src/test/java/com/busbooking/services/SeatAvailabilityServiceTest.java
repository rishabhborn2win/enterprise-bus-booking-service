...
class SeatAvailabilityServiceTest {
    ...
    @InjectMocks private SeatAvailabilityService seatAvailabilityService;
        ...
        allSeats =
                List.of(
                        ...
                        Seat.builder()
                                .id(501L)
                                .seatNumber("A1")
                                .seatClass(SeatClass.AC_SLEEPER)
                        ...
                        Seat.builder()
                                .id(503L)
                                .seatNumber("B1")
                                .seatClass(SeatClass.AC_SEATING)
    ...
    void getSegmentAvailability_FullTripSearch_ShouldBlockSeatsForEntireRoute() {
        ...
        when(bookingSeatRepository.findConfirmedBookedSeatSegmentsWithOrders(SCHEDULE_ID))
                .thenReturn(bookedSegments);
        when(scheduleStopRepository.findStopOrderByScheduleIdAndStopId(SCHEDULE_ID, MUMBAI_ID))
                .thenReturn(Optional.of(1));
        when(scheduleStopRepository.findStopOrderByScheduleIdAndStopId(SCHEDULE_ID, BANGALORE_ID))
                .thenReturn(Optional.of(3));

        // Act
        SeatAvailabilityResponse response =
                seatAvailabilityService.getSegmentAvailability(
                        SCHEDULE_ID, MUMBAI_ID, BANGALORE_ID);
    ...
    void getSegmentAvailability_FirstSegmentSearch_ShouldOnlyBlockSegment1Seats() {
        ...
        when(scheduleStopRepository.findStopOrderByScheduleIdAndStopId(SCHEDULE_ID, MUMBAI_ID))
                .thenReturn(Optional.of(1));
        when(scheduleStopRepository.findStopOrderByScheduleIdAndStopId(SCHEDULE_ID, PUNE_ID))
                .thenReturn(Optional.of(2));

        // Act
        SeatAvailabilityResponse response =
                seatAvailabilityService.getSegmentAvailability(SCHEDULE_ID, MUMBAI_ID, PUNE_ID);
    ...
    void getSegmentAvailability_SecondSegmentSearch_ShouldOnlyBlockSegment2Seats() {
        ...
        // Act
        SeatAvailabilityResponse response =
                seatAvailabilityService.getSegmentAvailability(SCHEDULE_ID, PUNE_ID, BANGALORE_ID);
    ...
    void getSegmentAvailability_InvalidStopOrder_ThrowsException() {
        ...
        IllegalArgumentException exception =
                assertThrows(
                        ...
                        () ->
                                seatAvailabilityService.getSegmentAvailability(
                                        SCHEDULE_ID, BANGALORE_ID, MUMBAI_ID));
    ...
    void getSegmentAvailability_NonexistentStop_ThrowsException() {
        ...
        when(scheduleStopRepository.findStopOrderByScheduleIdAndStopId(SCHEDULE_ID, MUMBAI_ID))
                .thenReturn(Optional.of(1));
        when(scheduleStopRepository.findStopOrderByScheduleIdAndStopId(
                        SCHEDULE_ID, NON_EXISTENT_STOP))
        ...
        assertThrows(
                ...
                () ->
                        seatAvailabilityService.getSegmentAvailability(
                                SCHEDULE_ID, MUMBAI_ID, NON_EXISTENT_STOP));
    }
}
