...
public class ScheduleRequestDto {
    ...
    public Schedule toScheduleEntity() { /* ... conversion logic ... */ return new Schedule(); }
    public List<ScheduleStop> toScheduleStopEntities(Schedule schedule) { /* ... conversion logic ... */ return List.of(); }
}
