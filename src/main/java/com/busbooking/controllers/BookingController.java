...
/**
 * Controller for Booking Operations. Defines the REST API endpoints.
 * Includes OpenAPI 3.0 annotations for interactive documentation.
 */
@RestController
@RequestMapping("/api/v1/bookings")
@RequiredArgsConstructor
@Tag(name = "Booking Operations", description = "CRUD operations and concurrency management for seat reservations.")
public class BookingController {
     ...
     * Reserves seats and places the booking in a PENDING state with a 10-minute lock.
     */
    @Operation(summary = "Reserve Seats", description = "Acquires a distributed lock and creates a PENDING booking (10 min hold).")
    @ApiResponse(responseCode = "202", description = "Seats reserved and booking created in PENDING state.")
     ...
     */
    @Operation(summary = "Confirm Booking", description = "Moves a PENDING booking to CONFIRMED state after payment success.")
     ...
     * Cancels a CONFIRMED booking and releases seats back to inventory.
     */
    @Operation(summary = "Cancel Booking", description = "Cancels a CONFIRMED booking and releases reserved seats.")
