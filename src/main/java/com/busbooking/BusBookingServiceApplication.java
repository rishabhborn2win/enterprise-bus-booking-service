...
/**
 * Main application class for the Bus Booking Service. Enables Spring Boot features, scheduling for
 * cleanup, and JPA.
 */
...
public class BusBookingServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Bus Booking Service is running! Access Swagger UI at: http://localhost:8080/swagger-ui.html");
    }
}
